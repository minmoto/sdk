...
import { EscrowAsset, EscrowCurrency, EscrowNetwork, PayoutDestinationType, type EscrowFeePolicy, type PayoutDestination } from "./types";
...
export declare const DEFAULT_ESCROW_FUNDING_RECONCILIATION_INTERVAL_SECONDS = 30;
